...
def GGQLambda_same_parameter(ave_times=20,
    ...
    with open(
            "/Users/Finn/Dropbox/Lehrveranstaltungen/Forschungspraxis/Project/data/total_reward_GGQ-" + str(learning_rate) + "-" + str(eligibility_factor), 'wb') as f:
        pickle.dump(total_reward_episode, f)
    with open(
            "/Users/Finn/Dropbox/Lehrveranstaltungen/Forschungspraxis/Project/data/time_history_GGQ-" + str(learning_rate) + "-" + str(eligibility_factor), 'wb') as f:
...
def RGGQLambda_same_parameter(ave_times=20,
    ...
    with open(
            "/Users/Finn/Dropbox/Lehrveranstaltungen/Forschungspraxis/Project/data/total_reward_RGGQ-" + str(learning_rate) + "-" + str(eligibility_factor), 'wb') as f:
        pickle.dump(total_reward_episode_2, f)
    with open(
            "/Users/Finn/Dropbox/Lehrveranstaltungen/Forschungspraxis/Project/data/time_history_RGGQ-" + str(learning_rate) + "-" + str(eligibility_factor), 'wb') as f:
...
def OSK_Q_same_parameter(ave_times=20,
    ...
    with open(
            "/Users/Finn/Dropbox/Lehrveranstaltungen/Forschungspraxis/Project/data/total_reward_OSKQ-" + str(learning_rate) + "-" + str(eligibility_factor) + "-" + str(mu_2), 'wb') as f:
        pickle.dump(total_reward_episode_3, f)
    with open(
            "/Users/Finn/Dropbox/Lehrveranstaltungen/Forschungspraxis/Project/data/time_history_OSKQ-" + str(learning_rate) + "-" + str(eligibility_factor) + "-" + str(mu_2), 'wb') as f:
...
def same_parameter_run(eligibility_factor=0.9, mu_2=0.8):
    ...
    time_history = time_history_ave
    with open(
            "/Users/Finn/Dropbox/Lehrveranstaltungen/Forschungspraxis/Project/data/total_reward_episode-" + str(eligibility_factor) + "-" + str(mu_2), 'wb') as f:
        pickle.dump(total_reward_episode, f)
    with open(
            "/Users/Finn/Dropbox/Lehrveranstaltungen/Forschungspraxis/Project/data/time_history-" + str(eligibility_factor) + "-" + str(mu_2), 'wb') as f:
        pickle.dump(time_history, f)
    # Run algorithm
    for ave_times in range(AVE_TIMES):
        learning_agent_RGGQLambda = RGGQLambda(
    ...
    time_history_2 = time_history_ave_2
    with open(
            "/Users/Finn/Dropbox/Lehrveranstaltungen/Forschungspraxis/Project/data/total_reward_episode_2-" + str(eligibility_factor) + "-" + str(mu_2), 'wb') as f:
        pickle.dump(total_reward_episode_2, f)
    with open(
            "/Users/Finn/Dropbox/Lehrveranstaltungen/Forschungspraxis/Project/data/time_history_2-" + str(eligibility_factor) + "-" + str(mu_2), 'wb') as f:
        pickle.dump(time_history_2, f)
    ...
    time_history_3 = time_history_ave_3
    with open(
            "/Users/Finn/Dropbox/Lehrveranstaltungen/Forschungspraxis/Project/data/total_reward_episode_3-" + str(eligibility_factor) + "-" + str(mu_2), 'wb') as f:
        pickle.dump(total_reward_episode_3, f)
    with open(
            "/Users/Finn/Dropbox/Lehrveranstaltungen/Forschungspraxis/Project/data/time_history_3-" + str(eligibility_factor) + "-" + str(mu_2), 'wb') as f:
        pickle.dump(time_history_3, f)
